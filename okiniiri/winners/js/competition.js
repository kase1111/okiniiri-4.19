!(function (e) {
  ...
  },
  {
    ...
    "txt": "　私は、この本を読んで障害を抱えている人はとてもつらい、大変ということを改めて知りました。なぜなら、私自身も発達障害を抱えているからです。私は、発達障害と診断されてからは、自分がとても嫌になり、当時の友達とも距離をとっていました。しかし、診断されてから約二年後、この本と出会いました。この本に登場する俳優の栗原類さんも私と同じ発達障害を抱えていることを知り、私は、「障害を抱えているのに、何で。」という気持ちになり、私は気づきました。「障害を抱えていても、必ず、受け止めてくれる人がいるんだ。」と。その日から私は、当時の友達との間にあった壁をなくし、話をしたら、今になっては大親友です。必ず受け止める人はいる。"
  },
  {
    "id": "junior-5",
    "name": "田代悠太",
  ...
  },
  {
    ...
    "note01": "さくらももこ／著<br>©︎MOMOKO SAKURA",
    "note02": "集英社文庫",
    "opponent": "親友へ",
    "opponent_modal": "親友へ",
